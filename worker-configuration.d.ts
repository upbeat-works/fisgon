/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c90f747ac777c1822b82d3a3b9815249)
// Runtime types generated with workerd@1.20260205.0 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/agent/worker");
		durableNamespaces: "FisgonAgent";
	}
	interface Env {
		BROWSER: Fetcher;
		ACCOUNT_ID: "761909453e0f7ab0054e0466947f3ad0";
		AI_GATEWAY: "fisgon";
		AI_GATEWAY_TOKEN: string;
		FISGON_AGENT: DurableObjectNamespace<import("./src/agent/worker").FisgonAgent>;
	}
}
